...
3. Set the following environment variables:
   ...
   - `WAHA_API_KEY`: Auto-generated API key for authentication
...
**Note:** `WAHA_API_KEY` and `WAHA_DASHBOARD_PASSWORD` are auto-generated by Render for security.
...
### API Authentication
- **API Key:** Check Render environment variables for `WAHA_API_KEY`
